...
Chicago, Illinois 60640  & {\it E-mail:} austin@austinsonger.me\\              
{\it Citizenship:} USA  & {\it Website:} blog.austinvernsonger.com\\ 
...
{Eastern Illinois University - Champaign, Illinois  }{\textit{February 2015 - August 2016}}\vspace{0.2cm}
\\ 
\linebreak
%|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\osection{TECHNOLOGY}
%|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
\textbf{Languages}:  Python, Matlab\textbackslash Octave, BASH, JAVA, \LaTeX, HTML, HTML5, CSS, XML \\
...
\textbf{Server Side Applications}: Apache, MySQL, SAMBA,  Trac, Apache, NFS \& AutoFS,  BIND, LDAP\textbackslash NIS.\\
\textbf{Configuration Management \& Monitoring}: Wireshark\\
\textbf{Content Management Systems}: Ektron, Drupal, Joomla, Wordpress\\
\linebreak
%||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
%||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
\begin{itemize}
	...
	\item ITIL Foundations V3 - Planned December 2015
	\item Ec-Council Certified Ethical Hacker (CEH) - Planned January 2016
